...
public class RequestParamController {
     ...
     * /request-param-required -> username 이 없으면 예외
     *
     * 주의!
     * /request-param-required?username= -> 빈문자("")로 출력
     *
     * 주의!
     * @RequestParam(required = false)
     * /request-param-required?username=kim 하면 500 상태(서버문제) 발생
     * int age -> null 을 int 에 입력하는 것은 불가능, 따라서 Integer 로 변경해야 함
     ...
     * - defaultValue 사용
     *
     * 참고: defaultValue 는 빈 문자의 경우에도 사용
     ...
     * argument resolver - HttpServletRequest 와 같이 이미 지정된 타입
     */
    @ResponseBody
